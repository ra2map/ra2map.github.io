import{_ as f}from"./ValaxyMain.vue_vue_type_style_index_0_lang-DxC2i5ri.js";import{_ as b}from"./TxDownload.vue_vue_type_style_index_0_lang-Bt3c6gtA.js";import{_ as k}from"./AFace.vue_vue_type_style_index_0_lang-De7DCFkm.js";import{k as v,w as a,j as y,l as G,p as o,o as C,a as n,d as l,b as r,m as e}from"./app-DTK7MkJ3.js";import"./YunCloud-DCyQUbCJ.js";import"./tags-BE9ZZJqn.js";import"./YunFooter.vue_vue_type_script_setup_true_lang-CUf0HJdH.js";import"./YunCard.vue_vue_type_script_setup_true_lang-BEU4nSCu.js";import"./YunPostMeta.vue_vue_type_style_index_0_lang-BeL1C_Sa.js";import"./index-kt1v7PTw.js";import"./YunPageHeader.vue_vue_type_script_setup_true_lang-CQk4e2hF.js";import"./post-TpcOcCSC.js";const x={__name:"triggers-about-list",setup(S,{expose:c}){const i=JSON.parse('{"title":"需注册表触发如41动画&42爆炸解析","description":"","frontmatter":{"title":"需注册表触发如41动画&42爆炸解析","date":"2024-02-21","updated":"2024-02-21","categories":"触发与小队","tags":["进阶"],"author":"轻稚天雪"},"headers":[{"level":2,"title":"获取正确的注册表","slug":"获取正确的注册表","link":"#获取正确的注册表","children":[]},{"level":2,"title":"脚本们与19 建造特定类型的建筑","slug":"脚本们与19-建造特定类型的建筑","link":"#脚本们与19-建造特定类型的建筑","children":[]},{"level":2,"title":"41 播放动画","slug":"_41-播放动画","link":"#_41-播放动画","children":[]},{"level":2,"title":"42 爆炸在","slug":"_42-爆炸在","link":"#_42-爆炸在","children":[]},{"level":2,"title":"88 粒子动画","slug":"_88-粒子动画","link":"#_88-粒子动画","children":[]}],"relativePath":"pages/posts/triggers-about-list.md","path":"C:/code/web/valaxy-blog/pages/posts/triggers-about-list.md","lastUpdated":null}'),t=G(),u=i.frontmatter||{};return t.meta.frontmatter=Object.assign(t.meta.frontmatter||{},i.frontmatter||{}),o("pageData",i),o("valaxy:frontmatter",u),globalThis.$frontmatter=u,c({frontmatter:{title:"需注册表触发如41动画&42爆炸解析",date:"2024-02-21",updated:"2024-02-21",categories:"触发与小队",tags:["进阶"],author:"轻稚天雪"}}),(p,s)=>{const d=k,m=b,g=f;return C(),v(g,{frontmatter:y(u)},{"main-content-md":a(()=>[s[4]||(s[4]=n("h2",{id:"获取正确的注册表",tabindex:"-1"},[l("获取正确的注册表 "),n("a",{class:"header-anchor",href:"#获取正确的注册表","aria-label":'Permalink to "获取正确的注册表"'},"​")],-1)),s[5]||(s[5]=n("p",null,"在地图中，有很多触发条件/结果/脚本需要填入某个物件的 ID 号而非注册名，如",-1)),s[6]||(s[6]=n("ul",null,[n("li",null,"19 建造特定类型的建筑…"),n("li",null,"41 播放动画"),n("li",null,"42 爆炸在"),n("li",null,"88 粒子动画"),n("li",null,"46,N - 攻击N指定建筑"),n("li",null,"47,N - 移动到N指定敌方或中立建筑附近"),n("li",null,"56,N - 如果超时空传送就绪，则传送该小队至N指定建筑物"),n("li",null,"58,N - 移动到N指定友方建筑附近")],-1)),n("p",null,[s[0]||(s[0]=l("这些编号顺序在平台不同/ ini 不同时不同，而 FA2 中显示的往往是错误的，")),r(d,{face:"a:h",suffix:"jpg"}),s[1]||(s[1]=l("真的是")),s[2]||(s[2]=n("strong",null,"非常坑人",-1)),s[3]||(s[3]=l("。不过还是有许多人进行了许多探索，得到了一些有用的成果。"))]),s[7]||(s[7]=n("p",null,"由于每个人的 ini 有可能不同（自己新加了单位，或者是不同的 MOD），特别是 ARES 下还有拆分 ini，直接给出一个定死的序号表意义不大，因此需要一种可行的动态计算方式。",-1)),s[8]||(s[8]=n("p",null,[n("strong",null,"方法1"),l("：把列表（如建筑列表）复制进 excel，"),n("strong",null,"查找重复项并去掉重复项"),l("，从"),n("strong",null,"0"),l("开始重新生成序号")],-1)),s[9]||(s[9]=n("p",null,[n("strong",null,"方法2"),l("：见【其他教程  - 细节】平台bug：注册号漂移，下载 HTML 附件，运用程序动态计算列表（填入待整理的注册表名称如"),n("code",null,"InfantryTypes"),l("，进行计算）")],-1)),r(m,{size:"8.95KB",netdisk:"",direct:"rules注册号漂移计算.html",name:"rules注册号漂移计算.html"}),s[10]||(s[10]=n("p",null,[n("strong",null,"方法3"),l("（ARES 下推荐，所得结果与原版"),n("strong",null,"不通用"),l("）：使用 ARES 的 Debug 日志功能导出列表（说明书里有）：")],-1)),s[11]||(s[11]=n("ul",null,[n("li",null,"确保你使用了 ARES"),n("li",null,[l("在启动参数"),n("code",null,"RunAres.bat"),l("中添加"),n("code",null," -LOG"),l("，如"),n("code",null,'Syringe "gamemd.exe" %* -cd -speedcontrol -NOLOGO -LOG')]),n("li",null,[l("在游戏内快捷键选项"),n("code",null,"Development"),l("为"),n("code",null,"Dump Types"),l("指定一个快捷键（英文键盘），它将 Dumps the current type list to the log")]),n("li",null,"进入地图，按下你的快捷键，然后看到左上弹出提示"),n("li",null,[l("打开游戏目录下"),n("code",null,"debug/debug.log"),l("，往下翻，就有你想要的各种列表了哦。")])],-1)),s[12]||(s[12]=n("p",null,"下面咱再给出特定行为的解释以及可以直接用的列表。",-1)),s[13]||(s[13]=n("h2",{id:"脚本们与19-建造特定类型的建筑",tabindex:"-1"},[l("脚本们与19 建造特定类型的建筑 "),n("a",{class:"header-anchor",href:"#脚本们与19-建造特定类型的建筑","aria-label":'Permalink to "脚本们与19 建造特定类型的建筑"'},"​")],-1)),s[14]||(s[14]=n("p",null,[l("N=该建筑在注册列表中的【顺序号】，从【0】开始。脚本额外加判定系数，详见 prry 翻译的 "),n("em",null,"特遣脚本小队AI触发全教程(by prry).docx")],-1)),s[15]||(s[15]=n("h2",{id:"_41-播放动画",tabindex:"-1"},[l("41 播放动画 "),n("a",{class:"header-anchor",href:"#_41-播放动画","aria-label":'Permalink to "41 播放动画"'},"​")],-1)),s[16]||(s[16]=n("blockquote",null,[n("p",null,"在特定的路径点播放特定的动画，参数为[Animations]里的动画 ID。原版动画注册表存在序号漂移，建议使用脚本或 Excel 予以修正。")],-1)),s[17]||(s[17]=n("p",null,"yr1.001平台下，未修改 ini 时可以直接用的列表：",-1)),s[18]||(s[18]=n("div",{class:"language- vp-adaptive-theme"},[n("button",{title:"Copy Code",class:"copy"}),n("span",{class:"lang"}),n("pre",{class:"shiki shiki-themes github-light github-dark vp-code"},[n("code",{"v-pre":""},[n("span",{class:"line"},[n("span",null,"41 播放动画在...")]),l(`
...
`),n("span",{class:"line"},[n("span")]),l(`
`),n("span",{class:"line"},[n("span",null,"BY 秒")])])]),n("button",{class:"collapse"})],-1))]),"main-header":a(()=>[e(p.$slots,"main-header")]),"main-header-after":a(()=>[e(p.$slots,"main-header-after")]),"main-nav":a(()=>[e(p.$slots,"main-nav")]),"main-content":a(()=>[e(p.$slots,"main-content")]),"main-content-after":a(()=>[e(p.$slots,"main-content-after")]),"main-nav-before":a(()=>[e(p.$slots,"main-nav-before")]),"main-nav-after":a(()=>[e(p.$slots,"main-nav-after")]),comment:a(()=>[e(p.$slots,"comment")]),footer:a(()=>[e(p.$slots,"footer")]),aside:a(()=>[e(p.$slots,"aside")]),"aside-custom":a(()=>[e(p.$slots,"aside-custom")]),default:a(()=>[e(p.$slots,"default")]),_:3},8,["frontmatter"])}}};export{x as default};
