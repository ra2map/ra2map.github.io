import{_ as m}from"./ValaxyMain.vue_vue_type_style_index_0_lang-ClpXkmZy.js";import{_ as g}from"./TxDownload.vue_vue_type_style_index_0_lang-CQdNi4C6.js";import{i as b,w as a,h as f,j as k,p as o,o as v,a as n,b as l,g as y,l as e}from"./app-G45NqZuR.js";import"./helper-f8z8uJIo.js";import"./tags-D2-p_S_e.js";import"./YunFooter.vue_vue_type_script_setup_true_lang-Dqr4sQV6.js";import"./YunCard.vue_vue_type_script_setup_true_lang-HOw0TaWD.js";import"./index-C5okkQwF.js";import"./YunPostMeta.vue_vue_type_style_index_0_lang-Dzm6dkq3.js";import"./index-CpRw8AFc.js";import"./YunPageHeader.vue_vue_type_script_setup_true_lang-CcdLmUgK.js";import"./post-CsBZaeuw.js";const B={__name:"triggers-about-list",setup(G,{expose:r}){const i=JSON.parse('{"title":"需注册表触发如41动画&42爆炸解析","description":"","frontmatter":{"title":"需注册表触发如41动画&42爆炸解析","date":"2024-02-21","updated":"2024-02-21","categories":"触发与小队","tags":["进阶"],"author":"轻稚天雪"},"headers":[{"level":2,"title":"脚本们与19 建造特定类型的建筑","slug":"脚本们与19-建造特定类型的建筑","link":"#脚本们与19-建造特定类型的建筑","children":[]},{"level":2,"title":"41 播放动画","slug":"_41-播放动画","link":"#_41-播放动画","children":[]},{"level":2,"title":"42 爆炸在","slug":"_42-爆炸在","link":"#_42-爆炸在","children":[]},{"level":2,"title":"88 粒子动画","slug":"_88-粒子动画","link":"#_88-粒子动画","children":[]}],"relativePath":"pages/posts/triggers-about-list.md","path":"C:/code/web/valaxy-blog/pages/posts/triggers-about-list.md","lastUpdated":null}'),t=k(),u=i.frontmatter||{};return t.meta.frontmatter=Object.assign(t.meta.frontmatter||{},i.frontmatter||{}),o("pageData",i),o("valaxy:frontmatter",u),globalThis.$frontmatter=u,r({frontmatter:{title:"需注册表触发如41动画&42爆炸解析",date:"2024-02-21",updated:"2024-02-21",categories:"触发与小队",tags:["进阶"],author:"轻稚天雪"}}),(p,s)=>{const c=g,d=m;return v(),b(d,{frontmatter:f(u)},{"main-content-md":a(()=>[s[0]||(s[0]=n("p",null,"在地图中，有很多触发条件/结果/脚本需要填入某个物件的 ID 号而非注册名，如",-1)),s[1]||(s[1]=n("ul",null,[n("li",null,"19 建造特定类型的建筑…"),n("li",null,"41 播放动画"),n("li",null,"42 爆炸在"),n("li",null,"88 粒子动画"),n("li",null,"46,N - 攻击N指定建筑"),n("li",null,"47,N - 移动到N指定敌方或中立建筑附近"),n("li",null,"56,N - 如果超时空传送就绪，则传送该小队至N指定建筑物"),n("li",null,"58,N - 移动到N指定友方建筑附近")],-1)),s[2]||(s[2]=n("p",null,[l("这些编号顺序在平台不同/ ini 不同时不同，而 FA2 中显示的往往是错误的，真的是"),n("strong",null,"非常坑人"),l("。不过还是有许多人进行了许多探索，得到了一些有用的成果。")],-1)),s[3]||(s[3]=n("p",null,"由于每个人的 ini 有可能不同（自己新加了单位，或者是不同的 MOD），特别是 ARES 下还有拆分 ini，直接给出一个定死的序号表意义不大，因此需要一种可行的动态计算方式。",-1)),s[4]||(s[4]=n("p",null,[n("strong",null,"方法1"),l("：把列表（如建筑列表）复制进 excel，"),n("strong",null,"查找重复项并去掉重复项"),l("，从"),n("strong",null,"0"),l("开始重新生成序号")],-1)),s[5]||(s[5]=n("p",null,[n("strong",null,"方法2"),l("：见【其他教程  - 细节】平台bug：注册号漂移，下载 HTML 附件，运用程序动态计算列表（填入待整理的注册表名称如"),n("code",null,"InfantryTypes"),l("，进行计算）")],-1)),y(c,{size:"8.95KB",netdisk:"",direct:"rules注册号漂移计算.html",name:"rules注册号漂移计算.html"}),s[6]||(s[6]=n("p",null,[n("strong",null,"方法3"),l("（ARES 下推荐，所得结果与原版"),n("strong",null,"不通用"),l("）：使用 ARES 的 Debug 日志功能导出列表（说明书里有）：")],-1)),s[7]||(s[7]=n("ul",null,[n("li",null,"确保你使用了 ARES"),n("li",null,[l("在启动参数"),n("code",null,"RunAres.bat"),l("中添加"),n("code",null," -LOG"),l("，如"),n("code",null,'Syringe "gamemd.exe" %* -cd -speedcontrol -NOLOGO -LOG')]),n("li",null,[l("在游戏内快捷键选项"),n("code",null,"Development"),l("为"),n("code",null,"Dump Types"),l("指定一个快捷键（英文键盘），它将 Dumps the current type list to the log")]),n("li",null,"进入地图，按下你的快捷键，然后看到左上弹出提示"),n("li",null,[l("打开游戏目录下"),n("code",null,"debug/debug.log"),l("，往下翻，就有你想要的各种列表。")])],-1)),s[8]||(s[8]=n("p",null,"下面咱再给出特定行为的解释以及可以直接用的列表。",-1)),s[9]||(s[9]=n("h2",{id:"脚本们与19-建造特定类型的建筑",tabindex:"-1"},[l("脚本们与19 建造特定类型的建筑 "),n("a",{class:"header-anchor",href:"#脚本们与19-建造特定类型的建筑","aria-label":'Permalink to "脚本们与19 建造特定类型的建筑"'},"​")],-1)),s[10]||(s[10]=n("p",null,[l("N=该建筑在注册列表中的【顺序号】，从【0】开始。脚本额外加判定系数，详见 prry 翻译的 "),n("em",null,"特遣脚本小队AI触发全教程(by prry).docx")],-1)),s[11]||(s[11]=n("h2",{id:"_41-播放动画",tabindex:"-1"},[l("41 播放动画 "),n("a",{class:"header-anchor",href:"#_41-播放动画","aria-label":'Permalink to "41 播放动画"'},"​")],-1)),s[12]||(s[12]=n("blockquote",null,[n("p",null,"在特定的路径点播放特定的动画，参数为[Animations]里的动画 ID。原版动画注册表存在序号漂移，建议使用脚本或 Excel 予以修正。")],-1)),s[13]||(s[13]=n("p",null,"yr1.001平台下，未修改 ini 时可以直接用的列表：",-1)),s[14]||(s[14]=n("div",{class:"language- vp-adaptive-theme"},[n("button",{title:"Copy Code",class:"copy"}),n("span",{class:"lang"}),n("pre",{class:"shiki shiki-themes github-light github-dark vp-code"},[n("code",{"v-pre":""},[n("span",{class:"line"},[n("span",null,"41 播放动画在...")]),l(`
