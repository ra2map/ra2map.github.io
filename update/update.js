$(function () {
    if (typeof online == "undefined") {
        var latestVersion = '1.329（2023.1.2）';
        //1.139p2（2022.2.24）1.146（2022.3.28）1.173（2022.4.26）1.184（2022.5.15）V1.258（2022.7.11）1.274（2022.7.12）<!--V1.201（2022.6.16）V1.199（2022.5.28）1.191（2022.5.21）-->
