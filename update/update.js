if (typeof online == "undefined") {
    $(function () {
        var latestVersion = '1.191（2022.5.21）';//1.139p2（2022.2.24）1.146（2022.3.28）1.173（2022.4.26）1.184（2022.5.15）
        var currentVersion = ver || '未知';

        var box = $(".update");
        box.empty();
        if (currentVersion != latestVersion) {
            box.append("<p style='color: #777;'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;您的版本：" + currentVersion + "，最新版本：" + latestVersion + "，更新内容较少，您可以访问<a href='https://ra2map.github.io' target='_blank'>ra2map.github.io</a>浏览新版，也可以继续浏览本地版。</p><p>更新内容请至上述网站查看</p><br>");
        }
        else {
